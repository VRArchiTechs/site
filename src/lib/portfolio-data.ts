    ...
    galleries: [
      {
        ...
        plates: images.work.residence03B.gallery01.map((src, index) => ({
          ...
          caption: [
            ...
            "Seating & TV Wall Perspective",
            "Wide Interior Perspective",
            "TV Wall Elevation, Plan & Section",
            "Side Wall Elevation, Plan & Section",
          ][index],
        })),
      },
      {
        ...
        plates: images.work.residence03B.gallery02.map((src, index) => ({
          ...
          caption: [
            "Bed Wall Interior Perspective",
            "Bed Wall Elevation, Plan & Section",
            "Green Bed Wall Perspective",
            "Window Seat & Built-In Wardrobe",
            "TV Wall Perspective",
          ][index],
        })),
      },
