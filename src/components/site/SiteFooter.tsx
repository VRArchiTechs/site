...
export function SiteFooter() {
  return (
    <footer id="contact" className="border-t border-hair-dark bg-ink text-paper">
      <div className="mx-auto max-w-[1240px] px-6 py-24 md:px-10 md:py-36">
        <Reveal>
          ...
          <p className="mt-8 max-w-[46ch] text-[0.98rem] leading-[1.8] text-paper/65">
          ...
          <div className="mt-14 grid gap-8 border-t border-hair-dark pt-10 sm:grid-cols-2">
            <a
              ...
              className="font-display text-[clamp(1.2rem,2.6vw,1.9rem)] text-paper transition-colors hover:text-brass-soft"
            >
              {studio.email}
            </a>
            <a
              href={`tel:${studio.phone.replace(/\s/g, "")}`}
              className="font-display text-[clamp(1.2rem,2.6vw,1.9rem)] text-paper transition-colors hover:text-brass-soft sm:text-right"
            >
              {studio.phone}
            </a>
          </div>

          <p className="eyebrow mt-16 text-paper/40">
