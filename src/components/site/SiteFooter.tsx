      ...
      <div className="mx-auto max-w-[1240px] px-6 py-24 md:px-10 md:py-36">
        <Reveal>
          <div className="text-center">
            ...
            <div ref={taglineRef} className="mx-auto mt-8 w-full max-w-[1100px]">
              <div
                aria-hidden="true"
                className="mx-auto mb-8 h-px w-24 bg-brass-soft/60 origin-center transition-transform duration-700 ease-out motion-reduce:transition-none"
                style={lineStyle}
              />
              <h2 className="mx-auto max-w-[1100px] font-display text-[clamp(2.8rem,7vw,6.4rem)] leading-[0.94] tracking-[-0.025em]">
                <span className="block overflow-hidden">
                  <span
                    className="block transition-[opacity,transform] duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] motion-reduce:transition-none"
                    style={{
            ...
            <div className="mt-14 flex flex-col items-center justify-center gap-5 sm:flex-row sm:gap-10">
              <a
                ...
                className="font-display text-[clamp(1rem,2vw,1.25rem)] text-ink transition-colors hover:text-brass-soft"
              >
                {studio.email}
              </a>
              <a
          ...
          <div className="mt-20 flex flex-col gap-5 border-t border-hair-dark pt-8 text-ink/45 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex items-center gap-4 self-end sm:self-auto" aria-label="Social links">
              <a
